...
5. If authentication is required, note your **Username** and **Password**
...
<Note>
Phone numbers must be in E.164 format starting with `+` followed by country code and number (no spaces or dashes).
</Note>
