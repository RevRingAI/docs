...
The test panel on the right side of the agent page provides an easy way to send outbound test calls to your agent.

### Send a Test Call

1. Open your agent and use the **test panel** on the right
