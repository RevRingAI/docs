...
4. Choose a **Voice** that matches your selected language
...
curl -X POST https://api.revring.ai/v1/agents \
  ...
  -d '{
    ...
    "language": "es",
    "voiceId": "revring-pablo",
    "promptTemplate": "Eres un asistente de servicio al cliente. Ayuda al cliente {{customer_name}} con sus preguntas.",
...
3. In **Overview** tab:
   ...
   - Prompt: "Eres un asistente de servicio al cliente. Ayuda al cliente {{customer_name}} con sus preguntas."
