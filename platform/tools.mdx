...
- Response within 5 seconds (recommended: under 3 seconds for best user experience)
...
- **Response time**: 5 second timeout - webhooks must respond within this window
...
<AccordionGroup>
  ...
  <Accordion title="Tool returns error in transcript">
    ...
    - Verify webhook responds within 5 seconds
