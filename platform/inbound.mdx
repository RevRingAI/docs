...
<Tip>
If the same agent also places outbound calls and needs a different opening for them, set the **Outbound First Message** field (`firstMessageOutbound`). See [Separate Inbound and Outbound Openings](/platform/outbound#separate-inbound-and-outbound-openings).
</Tip>
