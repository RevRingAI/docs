...
2. Add an **Origination SIP URI**: `sip:sip.revring.ai`
...
3. Fill in the configuration:
   ...
   - **Proxy**: Your Twilio Termination SIP URI from Step 4 (e.g., `yourtrunk.pstn.twilio.com`) - enter just the domain without the `sip:` prefix
