...
2. Contact support for RevRing's SIP endpoint to add to your termination settings
...
<AccordionGroup>
  <Accordion title="Calls not connecting">
    ...
    - Check that your provider's termination settings include RevRing's SIP endpoint (contact support)
